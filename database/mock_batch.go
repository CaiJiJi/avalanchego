...
// Source: github.com/CaiJiJi/avalanchego/database (interfaces: Batch)
//
// Generated by this command:
//
//	mockgen -package=database -destination=database/mock_batch.go github.com/CaiJiJi/avalanchego/database Batch
//
