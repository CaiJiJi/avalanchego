...
// Source: github.com/CaiJiJi/avalanchego/database (interfaces: Iterator)
//
// Generated by this command:
//
//	mockgen -package=database -destination=database/mock_iterator.go github.com/CaiJiJi/avalanchego/database Iterator
//
