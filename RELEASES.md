...
- Make math.Add64 and math.Mul64 generic by @StephenButtolph in https://github.com/CaiJiJi/avalanchego/pull/3205
...
**Full Changelog**: https://github.com/CaiJiJi/avalanchego/compare/v1.11.8...v1.11.9
...
- @stellrust made their first contribution in https://github.com/CaiJiJi/avalanchego/pull/3075
...
- Remove pre-Durango networking checks by @StephenButtolph in https://github.com/CaiJiJi/avalanchego/pull/3018
...
## [v1.11.5](https://github.com/CaiJiJi/avalanchego/releases/tag/v1.11.5)
...
- Improve bootstrapping peer selection by @StephenButtolph in https://github.com/CaiJiJi/avalanchego/pull/2946
...
- Reuse key buffers during hashing by @StephenButtolph in https://github.com/CaiJiJi/avalanchego/pull/2902
...
- Remove legacy p2p message handling by @dhrubabasu in https://github.com/CaiJiJi/avalanchego/pull/2833
...
This version is backwards compatible to [v1.11.0](https://github.com/CaiJiJi/avalanchego/releases/tag/v1.11.0). It is optional, but strongly encouraged.
...
- Fix P-chain Shutdown deadlock by @StephenButtolph in https://github.com/CaiJiJi/avalanchego/pull/2686
...
**Full Changelog**: https://github.com/CaiJiJi/avalanchego/compare/v1.10.19...v1.11.0
...
- Cleanup database tests by @dhrubabasu in https://github.com/CaiJiJi/avalanchego/pull/2654
...
- ProposerVM Extend windows 0 - Cleanup by @abi87 in https://github.com/CaiJiJi/avalanchego/pull/2404
...
- `vms/platformvm`: Add `TestBuildBlockForceAdvanceTime` test by @dhrubabasu in https://github.com/CaiJiJi/avalanchego/pull/2472
...
- Initialize transactions once by @StephenButtolph in https://github.com/CaiJiJi/avalanchego/pull/2521
...
- Suppress gossip warnings due to no sampled peers by @StephenButtolph in https://github.com/CaiJiJi/avalanchego/pull/2562
...
- `x/sync`: Auto-generate `MockNetworkClient` by @dhrubabasu in https://github.com/CaiJiJi/avalanchego/pull/2617
...
- Periodically PullGossip only from connected validators by @StephenButtolph in https://github.com/CaiJiJi/avalanchego/pull/2399
...
- `merkledb` -- fix nil check in test by @danlaine in https://github.com/CaiJiJi/avalanchego/pull/2268
...
- Remove useless anon functions by @StephenButtolph in https://github.com/CaiJiJi/avalanchego/pull/2326
...
- Add `BaseTx` support to platformvm by @dhrubabasu in https://github.com/CaiJiJi/avalanchego/pull/2232
- Add `pebble` as valid value for `--db-type`. by @danlaine in https://github.com/CaiJiJi/avalanchego/pull/2244
- Add nullable option to codec by @nytzuga in https://github.com/CaiJiJi/avalanchego/pull/2171

**Full Changelog**: https://github.com/CaiJiJi/avalanchego/compare/v1.10.14...v1.10.15

## [v1.10.14](https://github.com/CaiJiJi/avalanchego/releases/tag/v1.10.14)
...
- Remove build check from unit tests by @StephenButtolph in https://github.com/CaiJiJi/avalanchego/pull/2189
- Update cgo usage by @StephenButtolph in https://github.com/CaiJiJi/avalanchego/pull/2184
- Deprecate IPC configs by @danlaine in https://github.com/CaiJiJi/avalanchego/pull/2168
- Update P2P proto docs by @joshua-kim in https://github.com/CaiJiJi/avalanchego/pull/2181
- Merkle db Make Paths only refer to lists of nodes by @dboehm-avalabs in https://github.com/CaiJiJi/avalanchego/pull/2143
- Deprecate keystore config by @danlaine in https://github.com/CaiJiJi/avalanchego/pull/2195
- Add tests for BanffBlock serialization by @dhrubabasu in https://github.com/CaiJiJi/avalanchego/pull/2194
- Move Shutdown lock from Handler into Engines by @StephenButtolph in https://github.com/CaiJiJi/avalanchego/pull/2179
- Move HealthCheck lock from Handler into Engines by @StephenButtolph in https://github.com/CaiJiJi/avalanchego/pull/2173
- Implement Heap Map by @joshua-kim in https://github.com/CaiJiJi/avalanchego/pull/2137
- Move selectStartGear lock from Handler into Engines by @StephenButtolph in https://github.com/CaiJiJi/avalanchego/pull/2182
- Add Heap Set by @joshua-kim in https://github.com/CaiJiJi/avalanchego/pull/2136
- Shutdown TimeoutManager during node Shutdown by @abi87 in https://github.com/CaiJiJi/avalanchego/pull/1707
- Redesign validator set management to enable tracking all subnets by @ceyonur in https://github.com/CaiJiJi/avalanchego/pull/1857
- Update local network readme by @StephenButtolph in https://github.com/CaiJiJi/avalanchego/pull/2203
- Use custom codec for validator metadata by @abi87 in https://github.com/CaiJiJi/avalanchego/pull/1510
- Add RSA max key length test by @StephenButtolph in https://github.com/CaiJiJi/avalanchego/pull/2205
- Remove duplicate networking check by @StephenButtolph in https://github.com/CaiJiJi/avalanchego/pull/2204
- Update TestDialContext to use ManuallyTrack by @joshua-kim in https://github.com/CaiJiJi/avalanchego/pull/2209
- Remove contains from validator manager interface by @ceyonur in https://github.com/CaiJiJi/avalanchego/pull/2198
- Move the overridden manager into the node by @ceyonur in https://github.com/CaiJiJi/avalanchego/pull/2199
- Remove `aggregate` struct by @dhrubabasu in https://github.com/CaiJiJi/avalanchego/pull/2213
- Add log for ungraceful shutdown on startup by @joshua-kim in https://github.com/CaiJiJi/avalanchego/pull/2215
- Add pebble database implementation by @danlaine in https://github.com/CaiJiJi/avalanchego/pull/1999
- Add `TransferSubnetOwnershipTx` by @dhrubabasu in https://github.com/CaiJiJi/avalanchego/pull/2178
- Revert networking AllowConnection change by @StephenButtolph in https://github.com/CaiJiJi/avalanchego/pull/2219
- Fix unexpected unlock by @StephenButtolph in https://github.com/CaiJiJi/avalanchego/pull/2221
- Improve logging for block verification failure by @StephenButtolph in https://github.com/CaiJiJi/avalanchego/pull/2224

**Full Changelog**: https://github.com/CaiJiJi/avalanchego/compare/v1.10.13...v1.10.14

## [v1.10.13](https://github.com/CaiJiJi/avalanchego/releases/tag/v1.10.13)
...
- Fix typo in block formation logic documentation by @kyoshisuki in https://github.com/CaiJiJi/avalanchego/pull/2158
- Marshal blocks and transactions inside API calls by @StephenButtolph in https://github.com/CaiJiJi/avalanchego/pull/2153
- Remove lock options from the info api by @StephenButtolph in https://github.com/CaiJiJi/avalanchego/pull/2149
- Remove write lock option from the avm static API by @StephenButtolph in https://github.com/CaiJiJi/avalanchego/pull/2154
- Remove write lock option from the avm wallet API by @StephenButtolph in https://github.com/CaiJiJi/avalanchego/pull/2155
- Fix json marshalling of Sets by @StephenButtolph in https://github.com/CaiJiJi/avalanchego/pull/2161
- Rename `removeSubnetValidatorValidation` to `verifyRemoveSubnetValidatorTx` by @dhrubabasu in https://github.com/CaiJiJi/avalanchego/pull/2162
- Remove lock options from the IPCs api by @StephenButtolph in https://github.com/CaiJiJi/avalanchego/pull/2151
- Remove write lock option from the xsvm API by @StephenButtolph in https://github.com/CaiJiJi/avalanchego/pull/2152
- Remove lock options from the admin API by @StephenButtolph in https://github.com/CaiJiJi/avalanchego/pull/2150
- Remove aliasing of `math` standard lib by @dhrubabasu in https://github.com/CaiJiJi/avalanchego/pull/2163
- Remove write lock option from the platformvm API by @StephenButtolph in https://github.com/CaiJiJi/avalanchego/pull/2157
- Remove write lock option from the avm rpc API by @StephenButtolph in https://github.com/CaiJiJi/avalanchego/pull/2156
- Remove context lock from API VM interface by @StephenButtolph in https://github.com/CaiJiJi/avalanchego/pull/2165
- Use set.Of rather than set.Add by @StephenButtolph in https://github.com/CaiJiJi/avalanchego/pull/2164
- Bump google.golang.org/grpc from 1.55.0 to 1.58.3 by @dependabot in https://github.com/CaiJiJi/avalanchego/pull/2159
- [x/merkledb] `Prefetcher` interface by @patrick-ogrady in https://github.com/CaiJiJi/avalanchego/pull/2167
- Validator Diffs: docs and UTs cleanup by @abi87 in https://github.com/CaiJiJi/avalanchego/pull/2037
- MerkleDB Reduce buffer creation/memcopy on path construction by @dboehm-avalabs in https://github.com/CaiJiJi/avalanchego/pull/2124
- Fix some P-chain UTs by @abi87 in https://github.com/CaiJiJi/avalanchego/pull/2117

### New Contributors

- @kyoshisuki made their first contribution in https://github.com/CaiJiJi/avalanchego/pull/2158

**Full Changelog**: https://github.com/CaiJiJi/avalanchego/compare/v1.10.12...v1.10.13

## [v1.10.12](https://github.com/CaiJiJi/avalanchego/releases/tag/v1.10.12)
...
- Add last accepted height to the snowman interface by @StephenButtolph in https://github.com/CaiJiJi/avalanchego/pull/2091
- Delete kurtosis CI jobs by @marun in https://github.com/CaiJiJi/avalanchego/pull/2068
- e2e: Ensure all Issue* calls use the default context by @marun in https://github.com/CaiJiJi/avalanchego/pull/2069
- Remove Finalized from the consensus interface by @StephenButtolph in https://github.com/CaiJiJi/avalanchego/pull/2093
- Remove embedding of `verify.Verifiable` in `FxCredential` by @dhrubabasu in https://github.com/CaiJiJi/avalanchego/pull/2089
- Clarify decidable interface simple default parameter tests by @gyuho in https://github.com/CaiJiJi/avalanchego/pull/2094
- snow/consensus/snowman/poll: remove "unused" no early term poller by @gyuho in https://github.com/CaiJiJi/avalanchego/pull/2095
- Cleanup `.golangci.yml` by @dhrubabasu in https://github.com/CaiJiJi/avalanchego/pull/2097
- Refactor `ancestor.Tree` by @StephenButtolph in https://github.com/CaiJiJi/avalanchego/pull/2099
- Update AMI runner image and instance type by @charlie-ava in https://github.com/CaiJiJi/avalanchego/pull/1939
- Add `tagalign` linter by @dhrubabasu in https://github.com/CaiJiJi/avalanchego/pull/2084
- Fix flaky BuildBlockIsIdempotent test by @StephenButtolph in https://github.com/CaiJiJi/avalanchego/pull/2101
- Make `network.dial` honor context cancellation. by @danlaine in https://github.com/CaiJiJi/avalanchego/pull/2061
- Add preference lookups by height to the consensus interface by @StephenButtolph in https://github.com/CaiJiJi/avalanchego/pull/2092
- Remove duplicate pullQuery method by @StephenButtolph in https://github.com/CaiJiJi/avalanchego/pull/2103
- Add additional validator set metrics by @aaronbuchwald in https://github.com/CaiJiJi/avalanchego/pull/2051
- Remove `snowball.Initialize` and `snowball.Factory` by @danlaine in https://github.com/CaiJiJi/avalanchego/pull/2104
- Remove initialize functions from the snowball package by @danlaine in https://github.com/CaiJiJi/avalanchego/pull/2105
- Remove `genesis.State` by @joshua-kim in https://github.com/CaiJiJi/avalanchego/pull/2112
- add `SetSubnetOwner` to `Chain` interface by @dhrubabasu in https://github.com/CaiJiJi/avalanchego/pull/2031
- Move vote bubbling before poll termination by @StephenButtolph in https://github.com/CaiJiJi/avalanchego/pull/2100
- testing: Switch upgrade test to testnet fixture by @marun in https://github.com/CaiJiJi/avalanchego/pull/1887
- Reduce archivedb key lengths by 1 byte by @StephenButtolph in https://github.com/CaiJiJi/avalanchego/pull/2113
- Cleanup uptime manager constructor by @abi87 in https://github.com/CaiJiJi/avalanchego/pull/2118
- MerkleDB Compact Path Bytes by @dboehm-avalabs in https://github.com/CaiJiJi/avalanchego/pull/2010
- MerkleDB Path changes cleanup by @dboehm-avalabs in https://github.com/CaiJiJi/avalanchego/pull/2120
- Fix consensus engine interface comments by @StephenButtolph in https://github.com/CaiJiJi/avalanchego/pull/2115
- Standardize consensus variable names in tests by @StephenButtolph in https://github.com/CaiJiJi/avalanchego/pull/2129
- Prevent bytesNeeded overflow by @StephenButtolph in https://github.com/CaiJiJi/avalanchego/pull/2130
- Migrate xsvm from github.com/ava-labs/xsvm by @marun in https://github.com/CaiJiJi/avalanchego/pull/2045
- Fix handling of wg in the networking dial test by @StephenButtolph in https://github.com/CaiJiJi/avalanchego/pull/2132
- Update go.mod and add update check by @StephenButtolph in https://github.com/CaiJiJi/avalanchego/pull/2133
- Reduce log level of failing to send a peerList message by @StephenButtolph in https://github.com/CaiJiJi/avalanchego/pull/2134
- RPCChainVM fail-fast health RPCs by @hexfusion in https://github.com/CaiJiJi/avalanchego/pull/2123
- MerkleDB allow warming node cache by @dboehm-avalabs in https://github.com/CaiJiJi/avalanchego/pull/2128
- Add vote bubbling metrics by @StephenButtolph in https://github.com/CaiJiJi/avalanchego/pull/2138
- Reduce log level of an error during Prune by @StephenButtolph in https://github.com/CaiJiJi/avalanchego/pull/2141
- Exit chain creation routine before shutting down chain router by @StephenButtolph in https://github.com/CaiJiJi/avalanchego/pull/2140
- Merkle db fix type cast bug by @dboehm-avalabs in https://github.com/CaiJiJi/avalanchego/pull/2142
- Add Warp Payload Types by @nytzuga in https://github.com/CaiJiJi/avalanchego/pull/2116
- Add height voting for chits by @StephenButtolph in https://github.com/CaiJiJi/avalanchego/pull/2102
- Add Heap Queue by @joshua-kim in https://github.com/CaiJiJi/avalanchego/pull/2135
- Add additional payload.Hash examples by @StephenButtolph in https://github.com/CaiJiJi/avalanchego/pull/2145
- Split Alpha into AlphaPreference and AlphaConfidence by @StephenButtolph in https://github.com/CaiJiJi/avalanchego/pull/2125

**Full Changelog**: https://github.com/CaiJiJi/avalanchego/compare/v1.10.11...v1.10.12

## [v1.10.11](https://github.com/CaiJiJi/avalanchego/releases/tag/v1.10.11)
...
- Rename platformvm/blocks to platformvm/block by @joshua-kim in https://github.com/CaiJiJi/avalanchego/pull/1980
- RewardValidatorTx cleanup by @abi87 in https://github.com/CaiJiJi/avalanchego/pull/1891
- Cancel stale SH actions by @danlaine in https://github.com/CaiJiJi/avalanchego/pull/2003
- e2e: Switch assertion library from gomega to testify by @marun in https://github.com/CaiJiJi/avalanchego/pull/1909
- e2e: Add bootstrap checks to migrated kurtosis tests by @marun in https://github.com/CaiJiJi/avalanchego/pull/1935
- Add `GetTransformSubnetTx` helper by @dhrubabasu in https://github.com/CaiJiJi/avalanchego/pull/2047
- Add readme for the staking/local folder by @StephenButtolph in https://github.com/CaiJiJi/avalanchego/pull/2046
- use `IsCortinaActivated` helper by @dhrubabasu in https://github.com/CaiJiJi/avalanchego/pull/2048
- add `D` upgrade boilerplate by @dhrubabasu in https://github.com/CaiJiJi/avalanchego/pull/2049
- e2e: Ensure interchain workflow coverage for the P-Chain by @marun in https://github.com/CaiJiJi/avalanchego/pull/1882
- e2e: Switch to using default timed context everywhere by @marun in https://github.com/CaiJiJi/avalanchego/pull/1910
- Remove indentation + confusing comment by @StephenButtolph in https://github.com/CaiJiJi/avalanchego/pull/2053
- Delete ErrDelegatorSubset by @joshua-kim in https://github.com/CaiJiJi/avalanchego/pull/2055
- Fix default validator start time by @marun in https://github.com/CaiJiJi/avalanchego/pull/2058
- Enable workflows to be triggered by merge queue by @marun in https://github.com/CaiJiJi/avalanchego/pull/2057
- e2e: Migrate staking rewards test from kurtosis by @marun in https://github.com/CaiJiJi/avalanchego/pull/1767
- Fix LRU documentation comment by @anusha-ctrl in https://github.com/CaiJiJi/avalanchego/pull/2036
- Ignore AppResponse timeouts for benching by @StephenButtolph in https://github.com/CaiJiJi/avalanchego/pull/2066
- trace: provide appName and version from Config by @najeal in https://github.com/CaiJiJi/avalanchego/pull/1893
- Update perms.WriteFile to write atomically  by @marun in https://github.com/CaiJiJi/avalanchego/pull/2063
- ArchiveDB by @nytzuga in https://github.com/CaiJiJi/avalanchego/pull/1911

**Full Changelog**: https://github.com/CaiJiJi/avalanchego/compare/v1.10.10...v1.10.11

## [v1.10.10](https://github.com/CaiJiJi/avalanchego/releases/tag/v1.10.10)
...
- e2e: Save network data for each test run as an uploaded artifact by @marun in https://github.com/CaiJiJi/avalanchego/pull/1856
- e2e: Ensure interchain workflow coverage for X-Chain and C-Chain by @marun in https://github.com/CaiJiJi/avalanchego/pull/1871
- MerkleDB Adjust New View function(s) by @dboehm-avalabs in https://github.com/CaiJiJi/avalanchego/pull/1927
- e2e: Migrate duplicate node id test from kurtosis by @marun in https://github.com/CaiJiJi/avalanchego/pull/1573
- Add tracing levels to merkledb by @StephenButtolph in https://github.com/CaiJiJi/avalanchego/pull/1933
- [x/merkledb] Add Configuration for `RootGenConcurrency` by @patrick-ogrady in https://github.com/CaiJiJi/avalanchego/pull/1936
- e2e: Ensure testnet network dir is archived on failed test run by @marun in https://github.com/CaiJiJi/avalanchego/pull/1930
- Merkle db cleanup view creation by @dboehm-avalabs in https://github.com/CaiJiJi/avalanchego/pull/1934
- Add async DB deletion helper by @StephenButtolph in https://github.com/CaiJiJi/avalanchego/pull/1931
- Implement SDK handler to drop messages from non-validators by @joshua-kim in https://github.com/CaiJiJi/avalanchego/pull/1917
- Support proposervm historical block deletion by @StephenButtolph in https://github.com/CaiJiJi/avalanchego/pull/1929
- Remove thread pool by @StephenButtolph in https://github.com/CaiJiJi/avalanchego/pull/1940
- Merkledb split node storage into value and intermediate by @dboehm-avalabs in https://github.com/CaiJiJi/avalanchego/pull/1918
- `merkledb` -- remove unneeded codec test helper by @danlaine in https://github.com/CaiJiJi/avalanchego/pull/1943
- `merkledb` -- add codec test and move helper by @danlaine in https://github.com/CaiJiJi/avalanchego/pull/1944
- Add throttler implementation to SDK by @joshua-kim in https://github.com/CaiJiJi/avalanchego/pull/1905
- Add Throttled Handler implementation to SDK by @joshua-kim in https://github.com/CaiJiJi/avalanchego/pull/1906
- Change merkledb caches to be size based by @StephenButtolph in https://github.com/CaiJiJi/avalanchego/pull/1947
- Rename `node.marshal` to `node.bytes` by @danlaine in https://github.com/CaiJiJi/avalanchego/pull/1951
- e2e: Switch to a default network node count of 2 by @marun in https://github.com/CaiJiJi/avalanchego/pull/1928
- MerkleDB Improve Node Size Calculation by @dboehm-avalabs in https://github.com/CaiJiJi/avalanchego/pull/1950
- `merkledb` -- remove unneeded return values by @danlaine in https://github.com/CaiJiJi/avalanchego/pull/1959
- `sync` -- reduce test sizes by @danlaine in https://github.com/CaiJiJi/avalanchego/pull/1962
- `merkledb` -- limit number of goroutines calculating node IDs by @danlaine in https://github.com/CaiJiJi/avalanchego/pull/1960
- Add gossip package to p2p SDK by @joshua-kim in https://github.com/CaiJiJi/avalanchego/pull/1958
- Improve state sync logging by @StephenButtolph in https://github.com/CaiJiJi/avalanchego/pull/1955
- Update golang to 1.20.8 by @StephenButtolph in https://github.com/CaiJiJi/avalanchego/pull/1826
- Use odd-numbered request ids for SDK by @joshua-kim in https://github.com/CaiJiJi/avalanchego/pull/1975
- update iterator invariant by @danlaine in https://github.com/CaiJiJi/avalanchego/pull/1978
- Document common usage of requestIDs for snow senders by @StephenButtolph in https://github.com/CaiJiJi/avalanchego/pull/1981
- e2e: Diagnose and fix flakes by @marun in https://github.com/CaiJiJi/avalanchego/pull/1941
- `merkledb` -- `db_test.go` cleanup by @danlaine in https://github.com/CaiJiJi/avalanchego/pull/1954
- `merkledb` -- make config fields uints by @danlaine in https://github.com/CaiJiJi/avalanchego/pull/1963
- Only gracefully exit rpcchainvm server after Shutdown by @StephenButtolph in https://github.com/CaiJiJi/avalanchego/pull/1988
- Add contexts to SDK callbacks by @joshua-kim in https://github.com/CaiJiJi/avalanchego/pull/1977
- Change max response size to target response size by @joshua-kim in https://github.com/CaiJiJi/avalanchego/pull/1995
- Add sdk gossip handler metrics by @joshua-kim in https://github.com/CaiJiJi/avalanchego/pull/1997
- Add p2p SDK Router metrics by @joshua-kim in https://github.com/CaiJiJi/avalanchego/pull/2000
- Merkledb Attempt to reduce test runtime by @dboehm-avalabs in https://github.com/CaiJiJi/avalanchego/pull/1990
- longer timeout on windows UT by @danlaine in https://github.com/CaiJiJi/avalanchego/pull/2001
- `sync` -- log tweaks by @danlaine in https://github.com/CaiJiJi/avalanchego/pull/2008
- Add Validator Gossiper by @joshua-kim in https://github.com/CaiJiJi/avalanchego/pull/2015
- database: comment that Get returns ErrNotFound if key is not present by @aaronbuchwald in https://github.com/CaiJiJi/avalanchego/pull/2018
- Return `height` from `GetCurrentSupply` by @dhrubabasu in https://github.com/CaiJiJi/avalanchego/pull/2022
- simplify platformvm `GetHeight` function by @dhrubabasu in https://github.com/CaiJiJi/avalanchego/pull/2023
- Merkle db fix range proof commit bug by @dboehm-avalabs in https://github.com/CaiJiJi/avalanchego/pull/2019
- Add `bag.Of` helper by @StephenButtolph in https://github.com/CaiJiJi/avalanchego/pull/2027
- Cleanup early poll termination logic by @StephenButtolph in https://github.com/CaiJiJi/avalanchego/pull/2029
- fix typo by @dhrubabasu in https://github.com/CaiJiJi/avalanchego/pull/2030
- Merkle db intermediate node key compression by @dboehm-avalabs in https://github.com/CaiJiJi/avalanchego/pull/1987
- Improve RPC Chain version mismatch error message by @martineckardt in https://github.com/CaiJiJi/avalanchego/pull/2021
- Move subnet owner lookup to platformvm state by @dhrubabasu in https://github.com/CaiJiJi/avalanchego/pull/2024
- Fix fuzz tests; add iterator fuzz test by @danlaine in https://github.com/CaiJiJi/avalanchego/pull/1991
- Refactor subnet validator primary network requirements by @dhrubabasu in https://github.com/CaiJiJi/avalanchego/pull/2014
- Rename events to event by @joshua-kim in https://github.com/CaiJiJi/avalanchego/pull/1973
- Add function to initialize SampleableSet by @joshua-kim in https://github.com/CaiJiJi/avalanchego/pull/2017
- add `IsCortinaActivated` helper by @dhrubabasu in https://github.com/CaiJiJi/avalanchego/pull/2013
- Fix P-chain Import by @StephenButtolph in https://github.com/CaiJiJi/avalanchego/pull/2035
- Rename avm/blocks package to avm/block by @joshua-kim in https://github.com/CaiJiJi/avalanchego/pull/1970
- Merkledb Update rangeproof proto to be consistent with changeproof proto by @dboehm-avalabs in https://github.com/CaiJiJi/avalanchego/pull/2040
- `merkledb` -- encode lengths as uvarints by @danlaine in https://github.com/CaiJiJi/avalanchego/pull/2039
- MerkleDB Remove GetNodeFromParent by @dboehm-avalabs in https://github.com/CaiJiJi/avalanchego/pull/2041

### New Contributors

- @martineckardt made their first contribution in https://github.com/CaiJiJi/avalanchego/pull/2021

**Full Changelog**: https://github.com/CaiJiJi/avalanchego/compare/v1.10.9...v1.10.10

## [v1.10.9](https://github.com/CaiJiJi/avalanchego/releases/tag/v1.10.9)
...
- `merkledb` -- verify range proof in fuzz test; fix bound error by @danlaine in https://github.com/CaiJiJi/avalanchego/pull/1789
- Update default compression type to zstd by @StephenButtolph in https://github.com/CaiJiJi/avalanchego/pull/1839
- Migrate to `uber-go/mock` by @dhrubabasu in https://github.com/CaiJiJi/avalanchego/pull/1840
- `corruptabledb` -- corrupt on iterator error by @danlaine in https://github.com/CaiJiJi/avalanchego/pull/1829
- Add support for Maps to the reflect_codec by @nytzuga in https://github.com/CaiJiJi/avalanchego/pull/1790
- Make linter fail if `github.com/golang/mock/gomock` is used by @danlaine in https://github.com/CaiJiJi/avalanchego/pull/1843
- Firewoodize merkle db Part 1: Make Views ReadOnly by @dboehm-avalabs in https://github.com/CaiJiJi/avalanchego/pull/1816
- E2E tests -- use appropriate timeouts by @danlaine in https://github.com/CaiJiJi/avalanchego/pull/1851
- e2e: Switch to testnet fixture by @marun in https://github.com/CaiJiJi/avalanchego/pull/1709
- `secp256k1` -- add fuzz tests by @danlaine in https://github.com/CaiJiJi/avalanchego/pull/1809
- Add fuzz test for complex codec unmarshalling by @StephenButtolph in https://github.com/CaiJiJi/avalanchego/pull/1846
- Simplify exported interface of the primary wallet by @StephenButtolph in https://github.com/CaiJiJi/avalanchego/pull/1849
- Regenerate mocks by @joshua-kim in https://github.com/CaiJiJi/avalanchego/pull/1860
- Remove history btree by @danlaine in https://github.com/CaiJiJi/avalanchego/pull/1861
- `merkledb` -- Remove `CommitToParent` by @danlaine in https://github.com/CaiJiJi/avalanchego/pull/1854
- `merkledb` -- remove other history btree by @danlaine in https://github.com/CaiJiJi/avalanchego/pull/1862
- `merkledb` -- add path fuzz test by @danlaine in https://github.com/CaiJiJi/avalanchego/pull/1852
- fix range proof verification case by @danlaine in https://github.com/CaiJiJi/avalanchego/pull/1834
- `merkledb` -- add change proof fuzz test; fix change proof verification by @danlaine in https://github.com/CaiJiJi/avalanchego/pull/1802
- Warp readme by @aaronbuchwald in https://github.com/CaiJiJi/avalanchego/pull/1780
- CODEOWNERS: add marun to tests by @hexfusion in https://github.com/CaiJiJi/avalanchego/pull/1863
- Add CI check that auto-generated code is up to date by @dhrubabasu in https://github.com/CaiJiJi/avalanchego/pull/1828
- `sync` -- change proof request can return range proof by @danlaine in https://github.com/CaiJiJi/avalanchego/pull/1772
- Ensure consistent use of best-practice `set -o` in all scripts by @marun in https://github.com/CaiJiJi/avalanchego/pull/1864
- GetCanonicalValidatorSet minimal ValidatorState iface by @darioush in https://github.com/CaiJiJi/avalanchego/pull/1875
- `sync` -- handle fatal error by @danlaine in https://github.com/CaiJiJi/avalanchego/pull/1874
- `merkledb` -- use `Maybe` for start bounds by @danlaine in https://github.com/CaiJiJi/avalanchego/pull/1872
- Add C-chain wallet to the primary network by @StephenButtolph in https://github.com/CaiJiJi/avalanchego/pull/1850
- e2e: Refactor keychain and wallet creation to test helpers by @marun in https://github.com/CaiJiJi/avalanchego/pull/1870
- Update account nonce on exportTx accept by @StephenButtolph in https://github.com/CaiJiJi/avalanchego/pull/1881
- `sync` -- add workheap test by @danlaine in https://github.com/CaiJiJi/avalanchego/pull/1879
- `merkledb` -- commit to db only by @danlaine in https://github.com/CaiJiJi/avalanchego/pull/1885
- Remove node/value lock from trieview by @dboehm-avalabs in https://github.com/CaiJiJi/avalanchego/pull/1865
- remove old todo by @danlaine in https://github.com/CaiJiJi/avalanchego/pull/1892
- Fix race in TestHandlerDispatchInternal by @joshua-kim in https://github.com/CaiJiJi/avalanchego/pull/1895
- Remove duplicate code from proposervm block acceptance by @StephenButtolph in https://github.com/CaiJiJi/avalanchego/pull/1894
- e2e: Bump permissionless subnets timeouts by @marun in https://github.com/CaiJiJi/avalanchego/pull/1897
- `merkledb` -- codec remove err checks by @danlaine in https://github.com/CaiJiJi/avalanchego/pull/1899
- Merkle db fix new return type by @dboehm-avalabs in https://github.com/CaiJiJi/avalanchego/pull/1898
- Add SDK Sampling interface by @joshua-kim in https://github.com/CaiJiJi/avalanchego/pull/1877
- Add NoOpHandler implementation to SDK by @joshua-kim in https://github.com/CaiJiJi/avalanchego/pull/1903
- Remove unused scripts by @StephenButtolph in https://github.com/CaiJiJi/avalanchego/pull/1908
- `merkledb` -- codec nits/cleanup by @danlaine in https://github.com/CaiJiJi/avalanchego/pull/1904
- `merkledb` -- preallocate `bytes.Buffer` in codec by @danlaine in https://github.com/CaiJiJi/avalanchego/pull/1900
- Proposervm height index repair fix by @abi87 in https://github.com/CaiJiJi/avalanchego/pull/1915
- `merkledb` -- move and rename methods by @danlaine in https://github.com/CaiJiJi/avalanchego/pull/1919
- Remove optional height indexing interface by @StephenButtolph in https://github.com/CaiJiJi/avalanchego/pull/1896
- `merkledb` -- nits by @danlaine in https://github.com/CaiJiJi/avalanchego/pull/1916
- Fix code owners file by @StephenButtolph in https://github.com/CaiJiJi/avalanchego/pull/1922
- Drop invalid TLS certs during initial handshake by @StephenButtolph in https://github.com/CaiJiJi/avalanchego/pull/1923
- Restricted tls metrics by @StephenButtolph in https://github.com/CaiJiJi/avalanchego/pull/1924

### New Contributors

- @nytzuga made their first contribution in https://github.com/CaiJiJi/avalanchego/pull/1790

**Full Changelog**: https://github.com/CaiJiJi/avalanchego/compare/v1.10.8...v1.10.9

## [v1.10.8](https://github.com/CaiJiJi/avalanchego/releases/tag/v1.10.8)
...
- Removes calls to ctrl.Finish by @darioush in https://github.com/CaiJiJi/avalanchego/pull/1803
- e2e: Remove unnecessary transaction status checking by @marun in https://github.com/CaiJiJi/avalanchego/pull/1786
- fix p2p mockgen location by @dhrubabasu in https://github.com/CaiJiJi/avalanchego/pull/1806
- fix end proof verification by @danlaine in https://github.com/CaiJiJi/avalanchego/pull/1801
- `merkledb` -- add proof fuzz test by @danlaine in https://github.com/CaiJiJi/avalanchego/pull/1804
- `sync` -- re-add network client metrics by @danlaine in https://github.com/CaiJiJi/avalanchego/pull/1787
- Add function to initialize set from elements by @joshua-kim in https://github.com/CaiJiJi/avalanchego/pull/1808
- Add Maybe to the end bound of proofs (Part 1) by @dboehm-avalabs in https://github.com/CaiJiJi/avalanchego/pull/1793
- add go version to --version by @amirhasanzadehpy in https://github.com/CaiJiJi/avalanchego/pull/1819
- e2e: Add local network fixture by @marun in https://github.com/CaiJiJi/avalanchego/pull/1700
- Fix test flake in TestProposalTxsInMempool by @StephenButtolph in https://github.com/CaiJiJi/avalanchego/pull/1822
- `sync` -- remove todo by @danlaine in https://github.com/CaiJiJi/avalanchego/pull/1788
- Add Maybe to the end bound of proofs (Part 2) by @dboehm-avalabs in https://github.com/CaiJiJi/avalanchego/pull/1813
- Move Maybe to its own package by @danlaine in https://github.com/CaiJiJi/avalanchego/pull/1817
- `merkledb` -- clarify/improve change proof invariants by @danlaine in https://github.com/CaiJiJi/avalanchego/pull/1810
- P-chain state prune + height index by @dhrubabasu in https://github.com/CaiJiJi/avalanchego/pull/1719
- Update maintainer of the debian packages by @StephenButtolph in https://github.com/CaiJiJi/avalanchego/pull/1825
- Make platformvm implement `block.HeightIndexedChainVM` by @dhrubabasu in https://github.com/CaiJiJi/avalanchego/pull/1746
- Add P-chain `GetBlockByHeight` API method by @dhrubabasu in https://github.com/CaiJiJi/avalanchego/pull/1747
- Update local genesis startTime by @ceyonur in https://github.com/CaiJiJi/avalanchego/pull/1811
- `sync` -- add handling for fatal error by @danlaine in https://github.com/CaiJiJi/avalanchego/pull/1690
- Add error logs for unexpected proposervm BuildBlock failures by @StephenButtolph in https://github.com/CaiJiJi/avalanchego/pull/1832
- Fix subnet validator set public key initialization by @StephenButtolph in https://github.com/CaiJiJi/avalanchego/pull/1833
- Document PendingTxs + BuildBlock consensus engine requirement by @StephenButtolph in https://github.com/CaiJiJi/avalanchego/pull/1835
- Bump github.com/supranational/blst from 0.3.11-0.20230406105308-e9dfc5ee724b to 0.3.11 by @dependabot in https://github.com/CaiJiJi/avalanchego/pull/1831
- Add Primary Network Lite Sync Option by @abi87 in https://github.com/CaiJiJi/avalanchego/pull/1769
- Check P-chain ShouldPrune during Initialize by @StephenButtolph in https://github.com/CaiJiJi/avalanchego/pull/1836

### New Contributors

- @amirhasanzadehpy made their first contribution in https://github.com/CaiJiJi/avalanchego/pull/1819
- @dependabot made their first contribution in https://github.com/CaiJiJi/avalanchego/pull/1831

**Full Changelog**: https://github.com/CaiJiJi/avalanchego/compare/v1.10.7...v1.10.8

## [v1.10.7](https://github.com/CaiJiJi/avalanchego/releases/tag/v1.10.7)

This version is backwards compatible to [v1.10.0](https://github.com/CaiJiJi/avalanchego/releases/tag/v1.10.0). This release contains meaningful performance improvements and we recommend updating as soon as possible.
...
- Remove deprecated configs by @ceyonur in https://github.com/CaiJiJi/avalanchego/pull/1712
- upgrade: Increase all ANR timeouts to 2m to ensure CI reliability by @marun in https://github.com/CaiJiJi/avalanchego/pull/1737
- fix sync panic by @danlaine in https://github.com/CaiJiJi/avalanchego/pull/1736
- remove `vm.state` re-assignment in tests by @dhrubabasu in https://github.com/CaiJiJi/avalanchego/pull/1739
- Expose BLS public keys from platform.getValidatorsAt by @StephenButtolph in https://github.com/CaiJiJi/avalanchego/pull/1740
- Fix validator set diff tests by @StephenButtolph in https://github.com/CaiJiJi/avalanchego/pull/1744
- Replace List() with Map() on validators.Set by @StephenButtolph in https://github.com/CaiJiJi/avalanchego/pull/1745
- vms/platformvm: configure state cache sizes #1522 by @najeal in https://github.com/CaiJiJi/avalanchego/pull/1677
- Support both `stateBlk`s and `Block`s in `blockDB` by @dhrubabasu in https://github.com/CaiJiJi/avalanchego/pull/1748
- Add `DefaultExecutionConfig` var to `platformvm` by @dhrubabasu in https://github.com/CaiJiJi/avalanchego/pull/1749
- Remove hanging TODO from prior change by @StephenButtolph in https://github.com/CaiJiJi/avalanchego/pull/1758
- Write process context on node start to simplify test orchestration by @marun in https://github.com/CaiJiJi/avalanchego/pull/1729
- x/sync: add locks for peerTracker by @darioush in https://github.com/CaiJiJi/avalanchego/pull/1756
- Add ids length constants by @StephenButtolph in https://github.com/CaiJiJi/avalanchego/pull/1759
- [x/sync] Update target locking by @patrick-ogrady in https://github.com/CaiJiJi/avalanchego/pull/1763
- Export warp errors for external use by @aaronbuchwald in https://github.com/CaiJiJi/avalanchego/pull/1771
- Remove unused networking constant by @StephenButtolph in https://github.com/CaiJiJi/avalanchego/pull/1774
- Change the default value of `--network-allow-private-ips` to `false` for `mainnet` and `fuji` by @StephenButtolph in https://github.com/CaiJiJi/avalanchego/pull/1773
- Remove context.TODO from tests by @StephenButtolph in https://github.com/CaiJiJi/avalanchego/pull/1778
- Replace linkeddb iterator with native DB range queries by @StephenButtolph in https://github.com/CaiJiJi/avalanchego/pull/1752
- Add support for measuring key size in caches by @StephenButtolph in https://github.com/CaiJiJi/avalanchego/pull/1781
- Bump coreth to v0.12.5-rc.0 by @aaronbuchwald in https://github.com/CaiJiJi/avalanchego/pull/1775
- Add metric for the number of elements in a cache by @StephenButtolph in https://github.com/CaiJiJi/avalanchego/pull/1782
- Evict blocks based on size by @StephenButtolph in https://github.com/CaiJiJi/avalanchego/pull/1766
- Add proposervm state metrics by @StephenButtolph in https://github.com/CaiJiJi/avalanchego/pull/1785
- Register metercacher `len` metric by @StephenButtolph in https://github.com/CaiJiJi/avalanchego/pull/1791
- Reduce block cache sizes to 64 MiB by @StephenButtolph in https://github.com/CaiJiJi/avalanchego/pull/1794
- Add p2p sdk by @joshua-kim in https://github.com/CaiJiJi/avalanchego/pull/1799

**Full Changelog**: https://github.com/CaiJiJi/avalanchego/compare/v1.10.5...v1.10.7

## [v1.10.5](https://github.com/CaiJiJi/avalanchego/releases/tag/v1.10.5)
...
- stop persisting rejected blocks on P-chain by @dhrubabasu in https://github.com/CaiJiJi/avalanchego/pull/1696
- Ensure scripts/lint.sh failure when used with incompatible grep by @marun in https://github.com/CaiJiJi/avalanchego/pull/1711
- sum peers clock skew into metric by @najeal in https://github.com/CaiJiJi/avalanchego/pull/1695
- Make AVM implement `block.HeightIndexedChainVM` by @dhrubabasu in https://github.com/CaiJiJi/avalanchego/pull/1699
- ProposerVM nits by @abi87 in https://github.com/CaiJiJi/avalanchego/pull/1688
- Sorting -- Remove old `IsSortedAndUnique`, rename `IsSortedAndUniqueSortable` to `IsSortedAndUnique` by @danlaine in https://github.com/CaiJiJi/avalanchego/pull/1666
- Update snow consensus doc post X-chain linearization by @exdx in https://github.com/CaiJiJi/avalanchego/pull/1703
- `merkledb` / `sync` -- remove TODOs by @danlaine in https://github.com/CaiJiJi/avalanchego/pull/1718
- remove cache TODOs by @danlaine in https://github.com/CaiJiJi/avalanchego/pull/1721
- Adjust `NewSizedCache` to take in a size function by @dhrubabasu in https://github.com/CaiJiJi/avalanchego/pull/1725
- Wallet issuance to return tx instead of tx id by @felipemadero in https://github.com/CaiJiJi/avalanchego/pull/1704
- Add support for providing tracing headers by @StephenButtolph in https://github.com/CaiJiJi/avalanchego/pull/1727
- Only return accepted blocks in `GetStatelessBlock` by @dhrubabasu in https://github.com/CaiJiJi/avalanchego/pull/1724
- Proposermv fix goroutine leaks by @abi87 in https://github.com/CaiJiJi/avalanchego/pull/1713
- Update warp msg format by @aaronbuchwald in https://github.com/CaiJiJi/avalanchego/pull/1686
- Cleanup anr scripts by @ceyonur in https://github.com/CaiJiJi/avalanchego/pull/1714
- remove TrackBandwidth from NetworkClient by @danlaine in https://github.com/CaiJiJi/avalanchego/pull/1716
- Bump network start timeout by @marun in https://github.com/CaiJiJi/avalanchego/pull/1730
- e2e: Ensure e2e.test is built with portable BLST by @marun in https://github.com/CaiJiJi/avalanchego/pull/1734
- e2e: Increase all ANR timeouts to 2m to ensure CI reliability. by @marun in https://github.com/CaiJiJi/avalanchego/pull/1733

### New Contributors

- @exdx made their first contribution in https://github.com/CaiJiJi/avalanchego/pull/1703

**Full Changelog**: https://github.com/CaiJiJi/avalanchego/compare/v1.10.4...v1.10.5

## [v1.10.4](https://github.com/CaiJiJi/avalanchego/releases/tag/v1.10.4)
...
- e2e: Support testing on MacOS without requiring firewall exceptions by @marun in https://github.com/CaiJiJi/avalanchego/pull/1613
- Reduce resource log level by @StephenButtolph in https://github.com/CaiJiJi/avalanchego/pull/1622
- Improve `snow/` tests with `require` by @dhrubabasu in https://github.com/CaiJiJi/avalanchego/pull/1503
- Improve `x/` tests with `require` by @dhrubabasu in https://github.com/CaiJiJi/avalanchego/pull/1454
- `sync` -- fix `TestFindNextKeyRandom` by @danlaine in https://github.com/CaiJiJi/avalanchego/pull/1624
- Improve `vms/` tests with `require` by @dhrubabasu in https://github.com/CaiJiJi/avalanchego/pull/1505
- Improve `database/` tests with `require` by @dhrubabasu in https://github.com/CaiJiJi/avalanchego/pull/1506
- Ban usage of `t.Fatal` and `t.Error` by @dhrubabasu in https://github.com/CaiJiJi/avalanchego/pull/1453
- chore: fix typo in binary_snowflake.go by @eltociear in https://github.com/CaiJiJi/avalanchego/pull/1630
- Discriminate window fit err msg from overdelegated error msg by @felipemadero in https://github.com/CaiJiJi/avalanchego/pull/1606
- Remove MaxConnectionAge gRPC StreamID overflow mitigation by @hexfusion in https://github.com/CaiJiJi/avalanchego/pull/1388
- add fuzzing action by @danlaine in https://github.com/CaiJiJi/avalanchego/pull/1635
- Remove dagState and GetUTXOFromID by @StephenButtolph in https://github.com/CaiJiJi/avalanchego/pull/1632
- Update all AVM tests for post-linearization by @StephenButtolph in https://github.com/CaiJiJi/avalanchego/pull/1631
- Remove PendingTxs from the DAGVM interface by @StephenButtolph in https://github.com/CaiJiJi/avalanchego/pull/1641
- Remove GetTx from the DAGVM interface by @StephenButtolph in https://github.com/CaiJiJi/avalanchego/pull/1642
- Bump coreth v0.12.4 by @aaronbuchwald in https://github.com/CaiJiJi/avalanchego/pull/1646
- [x/merkledb] Remove useless `err` check by @patrick-ogrady in https://github.com/CaiJiJi/avalanchego/pull/1650
- [x/merkledb] Trailing whitespace removal on README by @patrick-ogrady in https://github.com/CaiJiJi/avalanchego/pull/1649
- Remove unneeded functions from UniqueTx by @StephenButtolph in https://github.com/CaiJiJi/avalanchego/pull/1643
- Simplify tx verification by @StephenButtolph in https://github.com/CaiJiJi/avalanchego/pull/1654
- `merkledb` --  fix `findNextKey` by @danlaine in https://github.com/CaiJiJi/avalanchego/pull/1653
- Cleanup X-chain UniqueTx Dependencies by @StephenButtolph in https://github.com/CaiJiJi/avalanchego/pull/1656
- Prune X-chain State by @coffeeavax in https://github.com/CaiJiJi/avalanchego/pull/1427
- Support building docker image on ARM64 by @dshiell in https://github.com/CaiJiJi/avalanchego/pull/1103
- remove goreleaser by @danlaine in https://github.com/CaiJiJi/avalanchego/pull/1660
- Fix Dockerfile on non amd64 platforms by @joshua-kim in https://github.com/CaiJiJi/avalanchego/pull/1661
- Improve metrics error message by @StephenButtolph in https://github.com/CaiJiJi/avalanchego/pull/1663
- Remove X-chain UniqueTx by @StephenButtolph in https://github.com/CaiJiJi/avalanchego/pull/1662
- Add state checksums by @StephenButtolph in https://github.com/CaiJiJi/avalanchego/pull/1658
- Modify proposervm window by @najeal in https://github.com/CaiJiJi/avalanchego/pull/1638
- sorting nit by @danlaine in https://github.com/CaiJiJi/avalanchego/pull/1665
- `merkledb` -- rewrite and test range proof invariants; fix proof generation/veriifcation bugs by @danlaine in https://github.com/CaiJiJi/avalanchego/pull/1629
- Add minimum proposer window length by @StephenButtolph in https://github.com/CaiJiJi/avalanchego/pull/1667
- CI -- only run fuzz tests on ubuntu by @danlaine in https://github.com/CaiJiJi/avalanchego/pull/1636
- `MerkleDB` -- remove codec version by @danlaine in https://github.com/CaiJiJi/avalanchego/pull/1671
- `MerkleDB` -- use default config in all tests by @danlaine in https://github.com/CaiJiJi/avalanchego/pull/1590
- `sync` -- reduce stuttering by @danlaine in https://github.com/CaiJiJi/avalanchego/pull/1672
- `Sync` -- unexport field by @danlaine in https://github.com/CaiJiJi/avalanchego/pull/1673
- `sync` -- nits and cleanup by @danlaine in https://github.com/CaiJiJi/avalanchego/pull/1674
- `sync` -- remove unused code by @danlaine in https://github.com/CaiJiJi/avalanchego/pull/1676
- Mark preForkBlocks after the fork as Rejected by @StephenButtolph in https://github.com/CaiJiJi/avalanchego/pull/1683
- `merkledb` -- fix comment by @danlaine in https://github.com/CaiJiJi/avalanchego/pull/1675
- `MerkleDB` -- document codec by @danlaine in https://github.com/CaiJiJi/avalanchego/pull/1670
- `sync` -- client cleanup by @danlaine in https://github.com/CaiJiJi/avalanchego/pull/1680
- Update buf version to v1.23.1 by @aaronbuchwald in https://github.com/CaiJiJi/avalanchego/pull/1685

### New Contributors

- @eltociear made their first contribution in https://github.com/CaiJiJi/avalanchego/pull/1630
- @felipemadero made their first contribution in https://github.com/CaiJiJi/avalanchego/pull/1606
- @dshiell made their first contribution in https://github.com/CaiJiJi/avalanchego/pull/1103
- @najeal made their first contribution in https://github.com/CaiJiJi/avalanchego/pull/1638

**Full Changelog**: https://github.com/CaiJiJi/avalanchego/compare/v1.10.3...v1.10.4

## [v1.10.3](https://github.com/CaiJiJi/avalanchego/releases/tag/v1.10.3)

This version is backwards compatible to [v1.10.0](https://github.com/CaiJiJi/avalanchego/releases/tag/v1.10.0). It is optional, but encouraged. The supported plugin version is `26`.
...
- `x/sync` -- Add proto for P2P messages  by @dboehm-avalabs in https://github.com/CaiJiJi/avalanchego/pull/1472
- Bump Protobuf and tooling and add section to proto docs outlining buf publishing by @hexfusion in https://github.com/CaiJiJi/avalanchego/pull/1552
- Minor pchain UTs cleanup by @abi87 in https://github.com/CaiJiJi/avalanchego/pull/1554
- Add ping uptimes test by @ceyonur in https://github.com/CaiJiJi/avalanchego/pull/1550
- Add workflow to mark stale issues and PRs by @joshua-kim in https://github.com/CaiJiJi/avalanchego/pull/1443
- Enforce inlining functions with a single error return in `require.NoError` by @dhrubabasu in https://github.com/CaiJiJi/avalanchego/pull/1500
- `x/sync` / `x/merkledb` -- add `SyncableDB` interface by @danlaine in https://github.com/CaiJiJi/avalanchego/pull/1555
- Rename beacon to boostrapper, define bootstrappers in JSON file for cross-language compatibility by @gyuho in https://github.com/CaiJiJi/avalanchego/pull/1439
- add P-chain height indexing by @dhrubabasu in https://github.com/CaiJiJi/avalanchego/pull/1447
- Add P-chain `GetBlockByHeight` API method by @dhrubabasu in https://github.com/CaiJiJi/avalanchego/pull/1448
- `x/sync` -- use for sending Range Proofs by @danlaine in https://github.com/CaiJiJi/avalanchego/pull/1537
- Add test to ensure that database packing produces sorted values by @StephenButtolph in https://github.com/CaiJiJi/avalanchego/pull/1560
- Randomize unit test execution order to identify unwanted dependency by @marun in https://github.com/CaiJiJi/avalanchego/pull/1565
- use `http.Error` instead of separately writing error code and message by @danlaine in https://github.com/CaiJiJi/avalanchego/pull/1564
- Adding allowed http hosts flag by @joshua-kim in https://github.com/CaiJiJi/avalanchego/pull/1566
- `x/sync` -- Use proto for sending Change Proofs by @danlaine in https://github.com/CaiJiJi/avalanchego/pull/1541
- Only send `PushQuery` messages after building the block by @joshua-kim in https://github.com/CaiJiJi/avalanchego/pull/1428
- Rename APIAllowedOrigins to HTTPAllowedOrigins by @joshua-kim in https://github.com/CaiJiJi/avalanchego/pull/1567
- Add GetBalance examples for the P-chain and X-chain wallets by @StephenButtolph in https://github.com/CaiJiJi/avalanchego/pull/1569
- Reduce number of test iterations by @danlaine in https://github.com/CaiJiJi/avalanchego/pull/1568
- Re-add upgrade tests by @StephenButtolph in https://github.com/CaiJiJi/avalanchego/pull/1410
- Remove lists from Chits messages by @StephenButtolph in https://github.com/CaiJiJi/avalanchego/pull/1412
- Add more X-chain tests by @coffeeavax in https://github.com/CaiJiJi/avalanchego/pull/1487
- fix typo by @meaghanfitzgerald in https://github.com/CaiJiJi/avalanchego/pull/1570
- Reduce the number of test health checks by @StephenButtolph in https://github.com/CaiJiJi/avalanchego/pull/1571
- Fix proposervm.GetAncestors test flake by @StephenButtolph in https://github.com/CaiJiJi/avalanchego/pull/1572
- Remove list from AcceptedFrontier message by @StephenButtolph in https://github.com/CaiJiJi/avalanchego/pull/1578
- Remove version db from merkle db by @dboehm-avalabs in https://github.com/CaiJiJi/avalanchego/pull/1534
- `MerkleDB` -- add eviction batch size config by @danlaine in https://github.com/CaiJiJi/avalanchego/pull/1586
- `MerkleDB` -- fix `onEvictCache.Flush` by @danlaine in https://github.com/CaiJiJi/avalanchego/pull/1589
- Revert P-Chain height index by @StephenButtolph in https://github.com/CaiJiJi/avalanchego/pull/1591
- `x/sync` -- Add `SyncableDB` proto by @danlaine in https://github.com/CaiJiJi/avalanchego/pull/1559
- Clarify break on error during ancestors lookup by @hexfusion in https://github.com/CaiJiJi/avalanchego/pull/1580
- Add buf-push github workflow by @hexfusion in https://github.com/CaiJiJi/avalanchego/pull/1556
- Pchain bls key diff fix by @abi87 in https://github.com/CaiJiJi/avalanchego/pull/1584
- Cleanup fx interface compliance by @StephenButtolph in https://github.com/CaiJiJi/avalanchego/pull/1599
- Improve metrics error msging by @anusha-ctrl in https://github.com/CaiJiJi/avalanchego/pull/1598
- Separate health checks by tags by @StephenButtolph in https://github.com/CaiJiJi/avalanchego/pull/1579
- Separate subnet stake connected health and metrics from P-chain by @ceyonur in https://github.com/CaiJiJi/avalanchego/pull/1358
- Merkle db iterator by @dboehm-avalabs in https://github.com/CaiJiJi/avalanchego/pull/1533
- Fix unreadable message errors by @morrisettjohn in https://github.com/CaiJiJi/avalanchego/pull/1585
- Log unexpected errors during GetValidatorSet by @hexfusion in https://github.com/CaiJiJi/avalanchego/pull/1592
- `merkleDB` -- add inner heap type to syncWorkHeap by @danlaine in https://github.com/CaiJiJi/avalanchego/pull/1582
- `sync` -- explain algorithm in readme by @danlaine in https://github.com/CaiJiJi/avalanchego/pull/1600
- Rename license header file to avoid unintended license indexing by @StephenButtolph in https://github.com/CaiJiJi/avalanchego/pull/1608
- `merkledb` and `sync` -- use time based rand seed by @danlaine in https://github.com/CaiJiJi/avalanchego/pull/1607
- add `local-prefixes` setting for `goimports` by @dhrubabasu in https://github.com/CaiJiJi/avalanchego/pull/1612
- snow/engine/snowman: instantiate voter after issuer by @gyuho in https://github.com/CaiJiJi/avalanchego/pull/1610
- Update CodeQL to v2 by @StephenButtolph in https://github.com/CaiJiJi/avalanchego/pull/1616
- Remove old networking metric by @StephenButtolph in https://github.com/CaiJiJi/avalanchego/pull/1619
- Fix --http-host flag to support IPv6 by @StephenButtolph in https://github.com/CaiJiJi/avalanchego/pull/1620

### New Contributors

- @marun made their first contribution in https://github.com/CaiJiJi/avalanchego/pull/1565
- @meaghanfitzgerald made their first contribution in https://github.com/CaiJiJi/avalanchego/pull/1570
- @anusha-ctrl made their first contribution in https://github.com/CaiJiJi/avalanchego/pull/1598
- @morrisettjohn made their first contribution in https://github.com/CaiJiJi/avalanchego/pull/1585

**Full Changelog**: https://github.com/CaiJiJi/avalanchego/compare/v1.10.2...v1.10.3

## [v1.10.2](https://github.com/CaiJiJi/avalanchego/releases/tag/v1.10.2)
...
- use `require` library functions in tests by @dhrubabasu in https://github.com/CaiJiJi/avalanchego/pull/1451
- style nits in vm clients by @dhrubabasu in https://github.com/CaiJiJi/avalanchego/pull/1449
- utils/logging: add "Enabled" method to remove redundant verbo logs by @gyuho in https://github.com/CaiJiJi/avalanchego/pull/1461
- ban `require.EqualValues` by @dhrubabasu in https://github.com/CaiJiJi/avalanchego/pull/1457
- chains: do not hold write subnetsLock in health checks by @gyuho in https://github.com/CaiJiJi/avalanchego/pull/1460
- remove zstd check by @dhrubabasu in https://github.com/CaiJiJi/avalanchego/pull/1459
- use `require.IsType` for type assertions in tests by @dhrubabasu in https://github.com/CaiJiJi/avalanchego/pull/1458
- vms/platformvm/service: nits (preallocate address slice, error msg) by @gyuho in https://github.com/CaiJiJi/avalanchego/pull/1477
- ban `require.NotEqualValues` by @dhrubabasu in https://github.com/CaiJiJi/avalanchego/pull/1470
- use `require` in `api` and `utils/password` packages by @dhrubabasu in https://github.com/CaiJiJi/avalanchego/pull/1471
- use "golang.org/x/term" as "golang.org/x/crypto/ssh/terminal" is deprecated by @gyuho in https://github.com/CaiJiJi/avalanchego/pull/1464
- chains: move "msgChan" closer to the first use (readability) by @gyuho in https://github.com/CaiJiJi/avalanchego/pull/1484
- ban function params for `require.ErrorIs` by @dhrubabasu in https://github.com/CaiJiJi/avalanchego/pull/1486
- standardize imports by @dhrubabasu in https://github.com/CaiJiJi/avalanchego/pull/1466
- fix license header test by @dhrubabasu in https://github.com/CaiJiJi/avalanchego/pull/1492
- use blank identifier for interface compliance by @dhrubabasu in https://github.com/CaiJiJi/avalanchego/pull/1493
- codec: remove "SetMaxSize" from "Manager", remove unnecessary lock by @gyuho in https://github.com/CaiJiJi/avalanchego/pull/1481
- config: disallow "ThrottlerConfig.MaxRecheckDelay" < 1 ms by @gyuho in https://github.com/CaiJiJi/avalanchego/pull/1435
- ban `require.Equal` when testing for `0` by @dhrubabasu in https://github.com/CaiJiJi/avalanchego/pull/1495
- Clean up MerkleDVB Sync Close lock by @dboehm-avalabs in https://github.com/CaiJiJi/avalanchego/pull/1469
- MerkleDB Cleanup by @dboehm-avalabs in https://github.com/CaiJiJi/avalanchego/pull/1465
- Remove comment referencing old IP based tracking by @StephenButtolph in https://github.com/CaiJiJi/avalanchego/pull/1509
- ban usage of `require.Len` when testing for length `0` by @dhrubabasu in https://github.com/CaiJiJi/avalanchego/pull/1496
- ban usage of `require.Equal` when testing for length by @dhrubabasu in https://github.com/CaiJiJi/avalanchego/pull/1497
- ban usage of `nil` in require functions by @dhrubabasu in https://github.com/CaiJiJi/avalanchego/pull/1498
- Sized LRU cache by @abi87 in https://github.com/CaiJiJi/avalanchego/pull/1517
- engine/snowman: clean up some comments in "bubbleVotes" unit tests by @gyuho in https://github.com/CaiJiJi/avalanchego/pull/1444
- snow/networking/sender: add missing verbo check by @gyuho in https://github.com/CaiJiJi/avalanchego/pull/1504
- Delete duplicate test var definitions by @StephenButtolph in https://github.com/CaiJiJi/avalanchego/pull/1518
- utils/bag: print generic type for bag elements by @gyuho in https://github.com/CaiJiJi/avalanchego/pull/1507
- Fix incorrect test refactor by @abi87 in https://github.com/CaiJiJi/avalanchego/pull/1526
- Pchain validators repackaging by @abi87 in https://github.com/CaiJiJi/avalanchego/pull/1284
- Config overhaul by @ceyonur in https://github.com/CaiJiJi/avalanchego/pull/1370
- rename enabled staking to sybil protection enabled by @ceyonur in https://github.com/CaiJiJi/avalanchego/pull/1441
- Fix network compression type flag usage by @StephenButtolph in https://github.com/CaiJiJi/avalanchego/pull/1532
- Deprecate uptimes in pong message by @ceyonur in https://github.com/CaiJiJi/avalanchego/pull/1362
- Add CPU cycles and number of disk read/write metrics by pid by @coffeeavax in https://github.com/CaiJiJi/avalanchego/pull/1334
- Fetch process resource stats as best-effort by @StephenButtolph in https://github.com/CaiJiJi/avalanchego/pull/1543
- Add serialization tests for transactions added in Banff by @StephenButtolph in https://github.com/CaiJiJi/avalanchego/pull/1513
- Log chain shutdown duration by @StephenButtolph in https://github.com/CaiJiJi/avalanchego/pull/1545
- add interface for MerkleDB by @danlaine in https://github.com/CaiJiJi/avalanchego/pull/1519

### New Contributors

- @gyuho made their first contribution in https://github.com/CaiJiJi/avalanchego/pull/1461
- @coffeeavax made their first contribution in https://github.com/CaiJiJi/avalanchego/pull/1334

**Full Changelog**: https://github.com/CaiJiJi/avalanchego/compare/v1.10.1...v1.10.2

## [v1.10.1](https://github.com/CaiJiJi/avalanchego/releases/tag/v1.10.1)
...
- Add benchmark for gRPC GetValidatorSet by @hexfusion in https://github.com/CaiJiJi/avalanchego/pull/1326
- Add checks for database being closed in merkledb; other nits by @danlaine in https://github.com/CaiJiJi/avalanchego/pull/1333
- Update linkedhashmap to only Rlock when possible by @dboehm-avalabs in https://github.com/CaiJiJi/avalanchego/pull/1329
- Remove no-op changes from history results by @dboehm-avalabs in https://github.com/CaiJiJi/avalanchego/pull/1335
- Cleanup type assertions in the linkedHashmap by @StephenButtolph in https://github.com/CaiJiJi/avalanchego/pull/1341
- Fix racy avm tx access by @StephenButtolph in https://github.com/CaiJiJi/avalanchego/pull/1349
- Update Fuji beacon ips by @StephenButtolph in https://github.com/CaiJiJi/avalanchego/pull/1354
- Remove duplicate TLS verification by @StephenButtolph in https://github.com/CaiJiJi/avalanchego/pull/1364
- Adjust Merkledb Trie invalidation locking by @dboehm-avalabs in https://github.com/CaiJiJi/avalanchego/pull/1355
- Use require in Avalanche bootstrapping tests by @StephenButtolph in https://github.com/CaiJiJi/avalanchego/pull/1344
- Add Proof size limit to sync client by @dboehm-avalabs in https://github.com/CaiJiJi/avalanchego/pull/1269
- Add stake priority helpers by @StephenButtolph in https://github.com/CaiJiJi/avalanchego/pull/1375
- add contribution file by @joshua-kim in https://github.com/CaiJiJi/avalanchego/pull/1373
- Remove max sample value by @StephenButtolph in https://github.com/CaiJiJi/avalanchego/pull/1374
- Prefetch rpcdb iterator batches by @StephenButtolph in https://github.com/CaiJiJi/avalanchego/pull/1323
- Temp fix for flaky Sync Test by @dboehm-avalabs in https://github.com/CaiJiJi/avalanchego/pull/1378
- Update merkle cache to be FIFO instead of LRU by @dboehm-avalabs in https://github.com/CaiJiJi/avalanchego/pull/1353
- Improve cost of BLS key serialization for gRPC by @hexfusion in https://github.com/CaiJiJi/avalanchego/pull/1343
- [Issue-1368]: Panic in serializedPath.HasPrefix by @dboehm-avalabs in https://github.com/CaiJiJi/avalanchego/pull/1371
- Add ValidatorsOnly flag to GetStake by @StephenButtolph in https://github.com/CaiJiJi/avalanchego/pull/1377
- Use proto in `x/sync` by @danlaine in https://github.com/CaiJiJi/avalanchego/pull/1336
- Update incorrect fuji beacon IPs by @StephenButtolph in https://github.com/CaiJiJi/avalanchego/pull/1392
- Update `api/` error handling by @StephenButtolph in https://github.com/CaiJiJi/avalanchego/pull/1393
- refactor concurrent work limiting in sync in `x/sync` by @danlaine in https://github.com/CaiJiJi/avalanchego/pull/1347
- Remove check for impossible condition in `x/sync` by @danlaine in https://github.com/CaiJiJi/avalanchego/pull/1348
- Improve `codec/` error handling by @StephenButtolph in https://github.com/CaiJiJi/avalanchego/pull/1396
- Improve `config/` error handling by @StephenButtolph in https://github.com/CaiJiJi/avalanchego/pull/1397
- Improve `genesis/` error handling by @StephenButtolph in https://github.com/CaiJiJi/avalanchego/pull/1398
- Improve various error handling locations by @StephenButtolph in https://github.com/CaiJiJi/avalanchego/pull/1399
- Improve `utils/` error handling by @StephenButtolph in https://github.com/CaiJiJi/avalanchego/pull/1400
- Improve consensus error handling by @StephenButtolph in https://github.com/CaiJiJi/avalanchego/pull/1401
- Improve secp256k1fx + merkledb error handling by @StephenButtolph in https://github.com/CaiJiJi/avalanchego/pull/1402
- Ban usage of require.Error by @StephenButtolph in https://github.com/CaiJiJi/avalanchego/pull/1346
- Remove slice capacity hint in `x/sync` by @danlaine in https://github.com/CaiJiJi/avalanchego/pull/1350
- Simplify `syncWorkHeap` less function in `x/sync` by @danlaine in https://github.com/CaiJiJi/avalanchego/pull/1351
- Replace `switch` with `txs.Visitor` in X chain signer by @dhrubabasu in https://github.com/CaiJiJi/avalanchego/pull/1404
- Include IDs in json marshalling by @StephenButtolph in https://github.com/CaiJiJi/avalanchego/pull/1408
- Adjust find next key logic in x/Sync by @dboehm-avalabs in https://github.com/CaiJiJi/avalanchego/pull/1331
- Remove bitmask from writeMsgLen by @StephenButtolph in https://github.com/CaiJiJi/avalanchego/pull/1342
- Require `txID`s in PeerList messages by @StephenButtolph in https://github.com/CaiJiJi/avalanchego/pull/1411
- Allow dependent tx issuance over the wallet API by @StephenButtolph in https://github.com/CaiJiJi/avalanchego/pull/1413
- Add support for proto `message.Tx` decoding by @danlaine in https://github.com/CaiJiJi/avalanchego/pull/1332
- Remove avalanche bootstrapping -> avalanche consensus transition by @StephenButtolph in https://github.com/CaiJiJi/avalanchego/pull/1345
- Benchmark get canonical validator set by @aaronbuchwald in https://github.com/CaiJiJi/avalanchego/pull/1417
- Simplify IP status calculation by @StephenButtolph in https://github.com/CaiJiJi/avalanchego/pull/1421
- Honor AllowPrivateIPs config by @StephenButtolph in https://github.com/CaiJiJi/avalanchego/pull/1422
- Update BLS signature ordering to avoid public key compression by @StephenButtolph in https://github.com/CaiJiJi/avalanchego/pull/1416
- Remove DAG based consensus by @StephenButtolph in https://github.com/CaiJiJi/avalanchego/pull/1359
- Remove IssueStopVertex message by @StephenButtolph in https://github.com/CaiJiJi/avalanchego/pull/1419
- Fix msgHandlingTime by @StephenButtolph in https://github.com/CaiJiJi/avalanchego/pull/1432
- Change ChangeProofs to only have one list of key/value change instead of key/values and deleted by @dboehm-avalabs in https://github.com/CaiJiJi/avalanchego/pull/1385
- Update AMI generation workflow by @charlie-ava in https://github.com/CaiJiJi/avalanchego/pull/1289
- Support `height` as a string in `avm.getBlockByHeight` by @StephenButtolph in https://github.com/CaiJiJi/avalanchego/pull/1437
- Defer Snowman Bootstrapper parser initialization to Start by @StephenButtolph in https://github.com/CaiJiJi/avalanchego/pull/1442
- Cleanup proposervm ancestors packing @StephenButtolph in https://github.com/CaiJiJi/avalanchego/pull/1446

### New Contributors

- @hexfusion made their first contribution in https://github.com/CaiJiJi/avalanchego/pull/1326

**Full Changelog**: https://github.com/CaiJiJi/avalanchego/compare/v1.10.0...v1.10.1

## [v1.10.0](https://github.com/CaiJiJi/avalanchego/releases/tag/v1.10.0)
...
- Add CODEOWNERS for the x/ package by @StephenButtolph in https://github.com/CaiJiJi/avalanchego/pull/1260
- Feature Spec Template by @richardpringle in https://github.com/CaiJiJi/avalanchego/pull/1258
- Standardize CI triggers by @StephenButtolph in https://github.com/CaiJiJi/avalanchego/pull/1265
- special case no sent/received message in network health check by @ceyonur in https://github.com/CaiJiJi/avalanchego/pull/1263
- Fix bug template by @StephenButtolph in https://github.com/CaiJiJi/avalanchego/pull/1268
- Replace `flags` usage with `pflags` by @danlaine in https://github.com/CaiJiJi/avalanchego/pull/1270
- Fixed grammatical errors in `README.md` by @krakxn in https://github.com/CaiJiJi/avalanchego/pull/1102
- Add tests for race conditions in merkledb by @kyl27 in https://github.com/CaiJiJi/avalanchego/pull/1256
- Add P-chain indexer API example by @StephenButtolph in https://github.com/CaiJiJi/avalanchego/pull/1271
- use `require` in `snow/choices` tests by @dhrubabasu in https://github.com/CaiJiJi/avalanchego/pull/1279
- use `require` in `utils/wrappers` tests by @dhrubabasu in https://github.com/CaiJiJi/avalanchego/pull/1280
- add support for tracking delegatee rewards to validator metadata by @dhrubabasu in https://github.com/CaiJiJi/avalanchego/pull/1273
- defer delegatee rewards until end of validator staking period by @dhrubabasu in https://github.com/CaiJiJi/avalanchego/pull/1262
- Initialize UptimeCalculator in TestPeer by @joshua-kim in https://github.com/CaiJiJi/avalanchego/pull/1283
- Add Avalanche liveness health checks by @StephenButtolph in https://github.com/CaiJiJi/avalanchego/pull/1287
- Skip AMI generation with Fuji tags by @StephenButtolph in https://github.com/CaiJiJi/avalanchego/pull/1288
- Use `maps.Equal` in `set.Equals` by @danlaine in https://github.com/CaiJiJi/avalanchego/pull/1290
- return accrued delegator rewards in `GetCurrentValidators` by @dhrubabasu in https://github.com/CaiJiJi/avalanchego/pull/1291
- Add zstd compression by @danlaine in https://github.com/CaiJiJi/avalanchego/pull/1278
- implement `txs.Visitor` in X chain wallet by @dhrubabasu in https://github.com/CaiJiJi/avalanchego/pull/1299
- Parallelize gzip compression by @StephenButtolph in https://github.com/CaiJiJi/avalanchego/pull/1293
- Add zip bomb tests by @StephenButtolph in https://github.com/CaiJiJi/avalanchego/pull/1300
- Gossip Avalanche frontier after the linearization by @StephenButtolph in https://github.com/CaiJiJi/avalanchego/pull/1303
- Add fine grained metrics+logging for handling, processing, and grab l… by @aaronbuchwald in https://github.com/CaiJiJi/avalanchego/pull/1301
- Persist stateless block in AVM state by @StephenButtolph in https://github.com/CaiJiJi/avalanchego/pull/1305
- Initialize FxID fields in GetBlock and GetBlockByHeight by @StephenButtolph in https://github.com/CaiJiJi/avalanchego/pull/1306
- Filterable Health Tags by @ceyonur in https://github.com/CaiJiJi/avalanchego/pull/1304
- increase health await timeout by @ceyonur in https://github.com/CaiJiJi/avalanchego/pull/1317
- Expose GetEngineManager from the chain Handler by @StephenButtolph in https://github.com/CaiJiJi/avalanchego/pull/1316
- Add BLS benchmarks by @StephenButtolph in https://github.com/CaiJiJi/avalanchego/pull/1318
- Encode codec version in merkledb by @danlaine in https://github.com/CaiJiJi/avalanchego/pull/1313
- Expose consensus-app-concurrency by @StephenButtolph in https://github.com/CaiJiJi/avalanchego/pull/1322
- Adjust Logic In Merkle DB History by @dboehm-avalabs in https://github.com/CaiJiJi/avalanchego/pull/1310
- Fix Concurrency Bug In CommitToParent by @dboehm-avalabs in https://github.com/CaiJiJi/avalanchego/pull/1320
- Cleanup goroutines on health.Stop by @StephenButtolph in https://github.com/CaiJiJi/avalanchego/pull/1325

### New Contributors

- @richardpringle made their first contribution in https://github.com/CaiJiJi/avalanchego/pull/1258
- @ceyonur made their first contribution in https://github.com/CaiJiJi/avalanchego/pull/1263
- @krakxn made their first contribution in https://github.com/CaiJiJi/avalanchego/pull/1102
- @kyl27 made their first contribution in https://github.com/CaiJiJi/avalanchego/pull/1256
- @dhrubabasu made their first contribution in https://github.com/CaiJiJi/avalanchego/pull/1279
- @joshua-kim made their first contribution in https://github.com/CaiJiJi/avalanchego/pull/1283
- @dboehm-avalabs made their first contribution in https://github.com/CaiJiJi/avalanchego/pull/1310

**Full Changelog**: https://github.com/CaiJiJi/avalanchego/compare/v1.9.16...v1.10.0

## [v1.9.16](https://github.com/CaiJiJi/avalanchego/releases/tag/v1.9.16)

This version is backwards compatible to [v1.9.0](https://github.com/CaiJiJi/avalanchego/releases/tag/v1.9.0). It is optional, but encouraged. The supported plugin version is `24`.
...
## [v1.9.15](https://github.com/CaiJiJi/avalanchego/releases/tag/v1.9.15)
...
## [v1.9.14](https://github.com/CaiJiJi/avalanchego/releases/tag/v1.9.14)

This version is backwards compatible to [v1.9.0](https://github.com/CaiJiJi/avalanchego/releases/tag/v1.9.0). It is optional, but encouraged. The supported plugin version is `24`.

## [v1.9.13](https://github.com/CaiJiJi/avalanchego/releases/tag/v1.9.13)

This version is backwards compatible to [v1.9.0](https://github.com/CaiJiJi/avalanchego/releases/tag/v1.9.0). It is optional, but encouraged. The supported plugin version is `24`.

## [v1.9.12](https://github.com/CaiJiJi/avalanchego/releases/tag/v1.9.12)
...
## [v1.9.11](https://github.com/CaiJiJi/avalanchego/releases/tag/v1.9.11)
...
## [v1.9.10](https://github.com/CaiJiJi/avalanchego/releases/tag/v1.9.10)
...
## [v1.9.9](https://github.com/CaiJiJi/avalanchego/releases/tag/v1.9.9)

This version is backwards compatible to [v1.9.0](https://github.com/CaiJiJi/avalanchego/releases/tag/v1.9.0). It is optional, but encouraged. The supported plugin version is `23`.
...
## [v1.9.8](https://github.com/CaiJiJi/avalanchego/releases/tag/v1.9.8)

This version is backwards compatible to [v1.9.0](https://github.com/CaiJiJi/avalanchego/releases/tag/v1.9.0). It is optional, but encouraged. The supported plugin version is `22`.
...
## [v1.9.7](https://github.com/CaiJiJi/avalanchego/releases/tag/v1.9.7)
...
## [v1.9.6](https://github.com/CaiJiJi/avalanchego/releases/tag/v1.9.6)
...
## [v1.9.5](https://github.com/CaiJiJi/avalanchego/releases/tag/v1.9.5)

This version is backwards compatible to [v1.9.0](https://github.com/CaiJiJi/avalanchego/releases/tag/v1.9.0). It is optional, but encouraged. The supported plugin version is `21`.
...
## [v1.9.4](https://github.com/CaiJiJi/avalanchego/releases/tag/v1.9.4)

This version is backwards compatible to [v1.9.0](https://github.com/CaiJiJi/avalanchego/releases/tag/v1.9.0). It is optional, but encouraged. The supported plugin version is `20`.
...
## [v1.9.3](https://github.com/CaiJiJi/avalanchego/releases/tag/v1.9.3)

This version is backwards compatible to [v1.9.0](https://github.com/CaiJiJi/avalanchego/releases/tag/v1.9.0). It is optional, but encouraged. The supported plugin version is `19`.
...
## [v1.9.2](https://github.com/CaiJiJi/avalanchego/releases/tag/v1.9.2)
...
## [v1.9.1](https://github.com/CaiJiJi/avalanchego/releases/tag/v1.9.1)

This version is backwards compatible to [v1.9.0](https://github.com/CaiJiJi/avalanchego/releases/tag/v1.9.0). It is optional, but encouraged. The supported plugin version is `18`.
...
## [v1.9.0](https://github.com/CaiJiJi/avalanchego/releases/tag/v1.9.0)
...
## [v1.8.6](https://github.com/CaiJiJi/avalanchego/releases/tag/v1.8.6)

This version is backwards compatible to [v1.8.0](https://github.com/CaiJiJi/avalanchego/releases/tag/v1.8.0). It is optional, but encouraged. The supported plugin version is `16`.
...
## [v1.8.5](https://github.com/CaiJiJi/avalanchego/releases/tag/v1.8.5)
...
## [v1.8.4](https://github.com/CaiJiJi/avalanchego/releases/tag/v1.8.4)
...
## [v1.8.2](https://github.com/CaiJiJi/avalanchego/releases/tag/v1.8.2)
...
## [v1.8.1](https://github.com/CaiJiJi/avalanchego/releases/tag/v1.8.1)
...
## [v1.8.0](https://github.com/CaiJiJi/avalanchego/releases/tag/v1.8.0)
...
## [v1.7.18](https://github.com/CaiJiJi/avalanchego/releases/tag/v1.7.18)

This version is backwards compatible to [v1.7.0](https://github.com/CaiJiJi/avalanchego/releases/tag/v1.7.0). It is optional, but encouraged. The supported plugin version is `15`.
...
## [v1.7.17](https://github.com/CaiJiJi/avalanchego/releases/tag/v1.7.17)
...
## [v1.7.16](https://github.com/CaiJiJi/avalanchego/releases/tag/v1.7.16)
...
## [v1.7.15](https://github.com/CaiJiJi/avalanchego/releases/tag/v1.7.15)
...
## [v1.7.14](https://github.com/CaiJiJi/avalanchego/releases/tag/v1.7.14)

This version is backwards compatible to [v1.7.0](https://github.com/CaiJiJi/avalanchego/releases/tag/v1.7.0). It is optional, but encouraged.
...
## [v1.7.13](https://github.com/CaiJiJi/avalanchego/releases/tag/v1.7.13)
...
## [v1.7.12](https://github.com/CaiJiJi/avalanchego/releases/tag/v1.7.12)
...
## [v1.7.11](https://github.com/CaiJiJi/avalanchego/releases/tag/v1.7.11)
...
## [v1.7.10](https://github.com/CaiJiJi/avalanchego/releases/tag/v1.7.10)
...
## [v1.7.9](https://github.com/CaiJiJi/avalanchego/releases/tag/v1.7.9)
...
## [v1.7.8](https://github.com/CaiJiJi/avalanchego/releases/tag/v1.7.8)
...
## [v1.7.7](https://github.com/CaiJiJi/avalanchego/releases/tag/v1.7.7)
...
## [v1.7.6](https://github.com/CaiJiJi/avalanchego/releases/tag/v1.7.6)
...
## [v1.7.5](https://github.com/CaiJiJi/avalanchego/releases/tag/v1.7.5)
...
## [v1.7.4](https://github.com/CaiJiJi/avalanchego/releases/tag/v1.7.4)
...
## [v1.7.3](https://github.com/CaiJiJi/avalanchego/releases/tag/v1.7.3)
...
## [v1.7.2](https://github.com/CaiJiJi/avalanchego/releases/tag/v1.7.2)
...
## [v1.7.1](https://github.com/CaiJiJi/avalanchego/releases/tag/v1.7.1)

This update is backwards compatible with [v1.7.0](https://github.com/CaiJiJi/avalanchego/releases/tag/v1.7.0). Please see the expected update times in the v1.7.0 release.
...
## [v1.7.0](https://github.com/CaiJiJi/avalanchego/releases/tag/v1.7.0)
...
## [v1.6.5](https://github.com/CaiJiJi/avalanchego/releases/tag/v1.6.5)

This version is backwards compatible to [v1.6.0](https://github.com/CaiJiJi/avalanchego/releases/tag/v1.6.0). It is optional, but encouraged.
...
## [v1.6.4](https://github.com/CaiJiJi/avalanchego/releases/tag/v1.6.4)
...
## [v1.6.3](https://github.com/CaiJiJi/avalanchego/releases/tag/v1.6.3)
