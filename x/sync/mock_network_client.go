...
// Source: github.com/CaiJiJi/avalanchego/x/sync (interfaces: NetworkClient)
//
// Generated by this command:
//
//	mockgen -package=sync -destination=x/sync/mock_network_client.go github.com/CaiJiJi/avalanchego/x/sync NetworkClient
//
