...
// Source: github.com/CaiJiJi/avalanchego/api/server (interfaces: Server)
//
// Generated by this command:
//
//	mockgen -package=server -destination=api/server/mock_server.go github.com/CaiJiJi/avalanchego/api/server Server
//
