...
For an example of a JSON representation of genesis data, see [genesis_local.json](https://github.com/CaiJiJi/avalanchego/blob/master/genesis/genesis_local.json).
