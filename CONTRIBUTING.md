...
- Check that the issue you're filing doesn't already exist by searching under [issues](https://github.com/CaiJiJi/avalanchego/issues).
- If you're unable to find an open issue addressing the problem, [open a new one](https://github.com/CaiJiJi/avalanchego/issues/new/choose). Be sure to include a *title and clear description* with as much relevant information as possible.

## Features

- If you want to start a discussion about the development of a new feature or the modification of an existing one, start a thread under GitHub [discussions](https://github.com/CaiJiJi/avalanchego/discussions/categories/ideas).
...
- Ask any question about AvalancheGo under GitHub [discussions](https://github.com/CaiJiJi/avalanchego/discussions/categories/q-a).
