...
// Source: github.com/CaiJiJi/avalanchego/message (interfaces: OutboundMessage)
//
// Generated by this command:
//
//	mockgen -package=message -destination=message/mock_message.go github.com/CaiJiJi/avalanchego/message OutboundMessage
//
